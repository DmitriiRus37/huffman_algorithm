...
class TestApp(unittest.TestCase):
    def get_args(self, original_file_name, compressed_file_name):
        return [
            "",
            original_file_name,
    ...
    def test_1(self):
        ...
        self.common(original_file_name, compressed_file_name, decompressed_file_name)
    ...
    def common(self, original_file_name, compressed_file_name, decompressed_file_name):
        compress_args = self.get_args(original_file_name, compressed_file_name)
